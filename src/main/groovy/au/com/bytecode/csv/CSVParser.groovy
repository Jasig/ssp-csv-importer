...
class CSVParser {
    ...
    public String[] parseLineMulti(String nextLine) throws IOException {
        return parseLinePrivate(nextLine, true);
    }

    public String[] parseLine(String nextLine) throws IOException {
        return parseLinePrivate(nextLine, false);
    }
     ...
     */
    private String[] parseLinePrivate(String nextLine, boolean multi) throws IOException {
        ...
        if (nextLine == null) {
            if (pending != null) {
                String s = pending;
                pending = null;
                return Arrays.newInstance(String[])
            } else {
                return null;
            }
        }
    ...
    private boolean isNextCharacterEscapedQuote(String nextLine, boolean inQuotes, int i) {
        return inQuotes  && nextLine.length() > (i + 1) && nextLine.charAt(i + 1) == quotechar;// we are in quotes, therefore there can be escaped quotes in here.
